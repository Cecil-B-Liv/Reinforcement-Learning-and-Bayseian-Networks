...
def constructBayesNet(gameState: hunters.GameState):
    ...
    # "*** YOUR CODE HERE ***"
    # populate the variables with given constants
    ...
    variableDomainsDict = {
        ...
        GHOST0: mapList,
        GHOST1: mapList,
        OBS0: observedDistance,
        OBS1: observedDistance,
    }
...
def inferenceByVariableEliminationWithCallTracking(callTrackingList=None):
    ...
    def inferenceByVariableElimination(bayesNet: bn, queryVariables: List[str], evidenceDict: Dict, eliminationOrder: List[str]):
        ...
        # join all remaining factor
        resultFactor = joinFactors(updatedFactor) 
        
        return normalize(resultFactor)
        # Ensures the final probabilities sum to 1, converting the factor into a valid conditional probability distribution.
        # raiseNotDefined()
        # "*** END YOUR CODE HERE ***"
